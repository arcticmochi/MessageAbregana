...
import static com.example.messageabregana.MainActivity.PREF_NIGHT;
...
public class MessageActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE = "com.example.messageabregana.MESSAGE";
    public static final String EXTRA_RESULT = "com.example.messageabregana.RESULT";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        SharedPreferences preferences = getSharedPreferences("Abregana", Activity.MODE_PRIVATE);
    ...
    private void btnSaveListenerMethod() {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //This intent will carry the extra value good
